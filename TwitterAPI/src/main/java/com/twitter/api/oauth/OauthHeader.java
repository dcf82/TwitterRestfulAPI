...
import com.twitter.api.util.URIUtil;
...
public class OauthHeader {
    ...
    public static String buildRequestTokenHeader(
            String callbackUrl, String consumerKey, String nonce, String signature,
    ...
    public static String buildRequestHeader(
            String consumerKey, String nonce, String signature, String signatureMethod,
